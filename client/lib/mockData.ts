...
export const MOCK_RECEIPTS: Receipt[] = [
  {
    ...
    items: [
      { id: "li1", name: "Rice 5kg", quantity: 1, unitPrice: 320, totalPrice: 320 },
      { id: "li2", name: "Cooking Oil 1L", quantity: 2, unitPrice: 145, totalPrice: 290 },
      { id: "li3", name: "Dal 1kg", quantity: 1, unitPrice: 120, totalPrice: 120 },
      { id: "li4", name: "Spices Pack", quantity: 1, unitPrice: 115.5, totalPrice: 115.5 },
    ],
  },
  {
    id: "r2",
    ...
    ocrConfidence: 0.82,
    items: [
      { id: "li5", name: "Ride - Office to Home", quantity: 1, unitPrice: 342, totalPrice: 342 },
    ],
  },
  {
    id: "r3",
    ...
    ocrConfidence: 0.91,
    items: [
      { id: "li6", name: "Biryani", quantity: 1, unitPrice: 350, totalPrice: 350 },
      { id: "li7", name: "Bottled Water", quantity: 2, unitPrice: 20, totalPrice: 40 },
      { id: "li8", name: "Delivery Fee", quantity: 1, unitPrice: 30, totalPrice: 30 },
      { id: "li9", name: "Taxes & Charges", quantity: 1, unitPrice: 100, totalPrice: 100 },
    ],
  },
  {
    id: "r4",
    ...
    items: [
      { id: "li10", name: "Phone Case", quantity: 1, unitPrice: 799, totalPrice: 799 },
      { id: "li11", name: "Screen Guard", quantity: 1, unitPrice: 500, totalPrice: 500 },
    ],
  },
  {
    id: "r5",
    ...
    ocrConfidence: 0.55,
    items: [
      { id: "li12", name: "Medicines", quantity: 1, unitPrice: 680, totalPrice: 680 },
    ],
  },
  {
    id: "r6",
    ...
    ocrConfidence: 0.88,
    items: [
      { id: "li13", name: "Movie Ticket", quantity: 2, unitPrice: 350, totalPrice: 700 },
      { id: "li14", name: "Popcorn Combo", quantity: 1, unitPrice: 250, totalPrice: 250 },
    ],
  },
  {
    id: "r7",
    ...
    ocrConfidence: 0.92,
    items: [
      { id: "li15", name: "Fruits & Vegetables", quantity: 1, unitPrice: 450, totalPrice: 450 },
      { id: "li16", name: "Milk 1L", quantity: 4, unitPrice: 60, totalPrice: 240 },
      { id: "li17", name: "Bread", quantity: 2, unitPrice: 45, totalPrice: 90 },
      { id: "li18", name: "Eggs (12pk)", quantity: 1, unitPrice: 85, totalPrice: 85 },
      { id: "li19", name: "Snacks", quantity: 1, unitPrice: 255, totalPrice: 255 },
    ],
  },
];
